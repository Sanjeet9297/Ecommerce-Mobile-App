...
/**
 * Onboarding Step 3: Get Your Order
 */
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.paginationLabel}>3/3</Text>
        {/* Skip button navigates directly to Login */}
      ...
      <View style={styles.content}>
        <View style={styles.illustrationContainer}>
           <Image 
             source={require('../../assets/images/onboarding3_clean.png')} 
      ...
      <View style={styles.footer}>
        ...
        {/* Get Started button navigates to Login as requested */}
        <TouchableOpacity onPress={() => router.push('/auth/login')}>
